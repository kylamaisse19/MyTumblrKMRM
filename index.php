...
$acc_username = "KylaMarisse";
$acc_password = "kylamarisse";
$acc_fullname = "Kyla Marisse Marciano";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
					  ...
					  if(isset($_REQUEST['notexist'])===true){
						...
						echo "<div class='alert alert-info' role='alert'> Thank You... </div>";		
						  ...
						  echo "<div class='alert alert-warning' role='alert'> You are still logged in. Please <a href='account.php'> click here to proceed. </div>";
					  }
